...
const skillsData =[
    {id: 1, image: Javascript, title: 'Javascript', description: 'JavaScript, often abbreviated as JS, is a high-level, versatile programming language that is one of the core technologies of the World Wide Web, alongside HTML and CSS.'},
    {id: 2, image: React , title: 'ReactJs', description: 'a free and open-source JavaScript library specifically designed for building user interfaces (UIs).'},
    {id: 3, image: Tailwind, title: 'Tailwind Css', description: 'Tailwind CSS is a utility-first CSS framework for building custom user interfaces rapidly.'},
    {id: 4, image: Node, title: 'NodeJs', description: 'an open-source, cross-platform JavaScript runtime environment that allows you to execute JavaScript code outside of a web browser'},
    {id: 5, image: Supabase, title: 'Supabase', description: 'Supabase is an open-source backend-as-a-service (BaaS) that positions itself as an alternative to Google Firebase'}
]
        ...
        <div data-aos='fade-up' data-aos-delat='300' className='relative z-20 text-center space-y-6 sm:space-y-10'>
            ...
            <section data-aos='fade-up' data-aos-delay='500' className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-4'>
                {skillsData.map((skill) => (
                    <SkillsBox
                    key={skill.id} image={skill.image} title={skill.title} description={skill.description}  />
                ))}
            </section>
        </div>
