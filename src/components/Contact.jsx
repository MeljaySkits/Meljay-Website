...
function Contact() {
  ...
  return (
    <section
      ...
      data-aos="fade-up"
      data-aos-delay="300"
      className="min-h-screen overflow-hidden flex items-center p-6 mt-10 relative justify-center bg-slate-100"
    >
      <div className="shadow-2xl rounded-2xl flex flex-col md:flex-row max-w-4xl w-full relative bg-slate-300">
        ...
        <section className="p-8 w-full md:w-1/2">
          <header className="mb-6">
            <h2 className="text-4xl font-bold text-center text-cyan-950">
              Contact Me
            </h2>
          </header>
          <form ref={form} onSubmit={sendEmail} className="space-y-4">
            ...
            <div className="justify-center flex ">
              <button className=" bg-cyan-950 text-white border-2 px-6 py-2  focus:outline-none hover:text-cyan-950 hover:bg-slate-100 rounded-full cursor-pointer">
                Send Message
              </button>
            </div>
          </form>
      ...
      <div className="btn btn-ghost btn-circle absolute right-2 text-2xl text-cyan-950 hover:bg-cyan-950 hover:text-white">
